...
class gossip_router {
 ...
 private:
  message_id next_id();
  bool seen(
      const message_id& id);  // returns true if already seen; inserts otherwise
  void evict_sweep();
